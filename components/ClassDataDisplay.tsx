...
const ClassDataDisplay: React.FC<ClassDataDisplayProps> = ({ course, courseId }) => {
    ...
    ">
      {course.attendance.map((attendanceRecord, index) => (
        <div key={index} className="border-t pt-4">
          ...
          {/* <div className='w-full flex justify-end items-center'><Link href={`/edit/${courseId}/${course.topics[index].id}`}>Edit</Link> </div> */}
        </div>
      ))}
